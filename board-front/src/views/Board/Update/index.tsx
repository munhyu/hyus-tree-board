...
export default function BoardUpdate() {
  //          state: 제목 영역 요소 ref 상태          //
  const titleRef = useRef<HTMLTextAreaElement | null>(null);
  //          state: 본문 영역 요소 ref 상태          //
  ...
  //          event handler: 본문 내용 변경 이벤트 처리 함수          //
  ...
  //          event handler: 이미지 업로드 버튼 클릭 이벤트 처리 함수          //
    ...
    <div id="board-update-wrapper">
      <div className="board-update-container">
        <div className="board-update-box">
          ...
          <div className="board-update-image-upload-box">
            <div
